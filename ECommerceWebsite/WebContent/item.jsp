...
<body>
		...
		<div id="page">
			...
			<div id="center_column">				
				<div id=item_img>
					<img width="300px" height="225px" src="Picture/1.jpg" />
				</div>
				<div id=item_other>
					<form action="cart_view.jsp" method="post">
						品&nbsp;&nbsp;&nbsp;&nbsp;名：&nbsp;<span  style="font-size:15px;font-weight:bold;">油漆边双色龙骨扇_粉色</span><br>
						原&nbsp;&nbsp;&nbsp;&nbsp;价：&nbsp;<span  style="text-decoration: line-through;">28元</span><br>
						促&nbsp;&nbsp;&nbsp;&nbsp;销：&nbsp;<span  style="font-size:28px;font-weight:bold;color:#B22222;">18</span>元<br>
						售&nbsp;&nbsp;&nbsp;&nbsp;出：&nbsp;<span  style="font-weight:bold;color:#CC6600;">40</span>件<br>
