		...
		<div id="center_column">		
			<div class="divBorder">
				...
				<s:iterator value="#request.allProduct">
					<div id='sort_product'>
						<ul>
							<li><p class='gpic'><a href='item.jsp'><img width='205' height='154' src="<s:property value="img"/>"></a></p></li> 
							<li><p class='gbt'><a href='item.jsp'>品名：<s:property value="name"/></a></p></li>
